...
This package is copied from an OOTB package that contains the base functionality that you can use as a starting point to build a custom application.
...
Run `ng serve ccc-testgeneric` to serve the test generic app.
